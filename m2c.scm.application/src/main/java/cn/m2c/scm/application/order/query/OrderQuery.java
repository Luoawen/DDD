...
public class OrderQuery {
    ...
    public List<MainOrderBean> mainOrderListQuery(Integer orderStatus, Integer afterSaleStatus, String startTime, String orderId,
                                                  String endTime, String condition, Integer payWay, Integer mediaInfo, String dealerClassify, Integer pageNum, Integer rows, Integer commentStatus, Integer invoiceType) {
        ...
        if (null != commentStatus) {
            sql.append(" AND dl.comment_status =  ? ");
            params.add(commentStatus);
        }
        if (null != invoiceType) {
            sql.append(" AND dl.invoice_type =  ? ");
    ...
    public Integer mainOrderQueryTotal(Integer orderStatus, Integer afterSaleStatus, String startTime, String endTime,
                                       String condition, Integer payWay, Integer mediaInfo, String dealerClassify, Integer commentStatus, Integer invoiceType) {
        List<Object> params = new ArrayList<Object>();
        StringBuilder sql = new StringBuilder();
