...
public class GoodsSpecialDetailBean {
    ...
    private List<GoodsSkuSpecialBean> goodsSkuSpecials;

    public List<GoodsSkuSpecialBean> getGoodsSkuSpecials() {
		return goodsSkuSpecials;
	}

	public void setGoodsSkuSpecials(List<GoodsSkuSpecialBean> goodsSkuSpecials) {
