 ...
 * 管理平台导出
 */
public class GoodsServiceRateModelAll {
    ...
    public GoodsServiceRateModelAll(GoodsBean goodsBean, GoodsSkuBean goodsSkuBean, Map goodsClassifyMap, Float serviceRate, String goodsPostageName) {
