 ...
 * 新增修改配置 
 */
public class ConfigAddCommand  extends AssertionConcern implements Serializable {
	...
	public ConfigAddCommand(String configKey, String configValue, String configDescribe) throws NegativeException {
