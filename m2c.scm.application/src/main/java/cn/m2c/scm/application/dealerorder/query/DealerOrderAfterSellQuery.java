...
//		}
	...
	public DealerOrderAfterSellDetailBean afterSellDealerOrderDetailQeury(String afterSellOrderId, String dealerId) {
		...
		sql.append(" SELECT af._status,af.order_type,af.after_sell_order_id,af.back_money,af.reason, ")
	...
	public List<SaleAfterExpModel> orderSaleAfterExportQuery(Integer orderType, String dealerId, Integer status,
		...
		StringBuilder sql = new StringBuilder();
		sql.append(
				" SELECT dtl.discount_price saleAfterGoodsPrice, a.dealer_order_id dealerOrderId, a.sell_num sellNum, a.return_freight returnFreight, a.sku_id skuId, dtl.sku_name skuName, dtl.goods_name goodsName, dtl.goods_title goodsTitle,")
