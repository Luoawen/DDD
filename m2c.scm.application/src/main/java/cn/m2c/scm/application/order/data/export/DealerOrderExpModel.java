...
public class DealerOrderExpModel {
    ...
    public DealerOrderExpModel(DealerGoodsBean goodsBean, DealerOrderQB dealerOrderQB) {
        ...
        this.orderMoney = df1.format((dealerOrderQB.getGoodsMoney().floatValue() + dealerOrderQB.getOrderFreight().floatValue() - dealerOrderQB.getDealerDiscount().floatValue() - dealerOrderQB.getPlateDiscount().floatValue() - dealerOrderQB.getDdCouponDiscount()) / (double) 100);
        ...
        this.saleAfterMoney = df1.format((dealerOrderQB.getAfterMoney().floatValue() - dealerOrderQB.getCouponDiscount())/ (double) 100);
    }
}
