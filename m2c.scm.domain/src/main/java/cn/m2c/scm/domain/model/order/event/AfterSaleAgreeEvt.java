 ...
 * copyrighted@m2c
 */
public class AfterSaleAgreeEvt implements DomainEvent {
	...
	public AfterSaleAgreeEvt() {
		super();
		occurredOn = new Date();
		eventVersion = 1;
	}
	
	public AfterSaleAgreeEvt(String saleAfterNo, String orderId, String dealerOrderId, 
	...
	public static void main(String[] args) {
		Gson gson = new Gson();
		AfterSaleAgreeEvt a = new AfterSaleAgreeEvt("123456", "AFAA3333", "a85adfsf", "dealerId", 3000, 0, 0, "", 0);
