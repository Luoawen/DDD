...
public class GoodsAppViewMDEvent extends AssertionConcern implements DomainEvent {
	...
	public GoodsAppViewMDEvent() {
		super();
	}
	
	

	public GoodsAppViewMDEvent(String sn, String os, String appVersion,
