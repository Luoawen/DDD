...
public class AfterSellOrderAgent {
	...
	public ResponseEntity<MResult> getAftreSellLogistics(@RequestParam(value = "afterSellOrderId",required = false)String afterSellOrderId) {
		MResult result = new MResult(MCode.V_1);
		try {
			AftreSellLogisticsBean afterSellOrderLogistics = afterSellOrderQuery.afterSellOrderLogisticsQuery(afterSellOrderId);
			System.out.println("获取到得物流信息数据---------------------------"+afterSellOrderLogistics);
			if (null != afterSellOrderLogistics) {
	...
	public ResponseEntity<MResult> afterSellOrderDetail(@RequestParam(value = "afterSellOrderId",required = false)String afterSellOrderId) {
		MResult result = new MResult(MCode.V_1);
		try {
			AfterSellOrderDetailBean afterSellOrderDetail = afterSellOrderQuery.afterSellOrderDetailQeury(afterSellOrderId);
