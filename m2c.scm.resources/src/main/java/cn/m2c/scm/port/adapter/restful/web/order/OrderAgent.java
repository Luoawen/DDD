...
public class OrderAgent {
    ...
    public ResponseEntity<MPager> getOrderList(
        ...
        try {
            Integer total = orderQuery.mainOrderQueryTotal(orderStatus, afterSellStatus, startTime, endTime, condition, payWay, mediaInfo, dealerClassify, commentStatus, invoiceType);
            List<MainOrderBean> mainOrderList = orderQuery.mainOrderListQuery(orderStatus, afterSellStatus, startTime, orderId, endTime, condition, payWay, mediaInfo, dealerClassify, pageNum, rows , commentStatus, invoiceType);
