package cn.m2c.scm.port.adapter.restful.mini.order;
...
public class MiniOrderAgent {

    private final static Logger LOGGER = LoggerFactory.getLogger(MiniOrderAgent.class);
     ...
     * @return
     */
    @RequestMapping(value = "/aftersale/ship", method = {RequestMethod.PUT, RequestMethod.POST})
     ...
     * @return
     */
    @RequestMapping(value = "/aftersale/user-rev", method = {RequestMethod.PUT, RequestMethod.POST})
     ...
     * @return
     */
    @RequestMapping(value = "/orderdtl", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/saleAfter/list", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/may/saleAfter/list", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/dealer/statics", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/applyReason",method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/registExpress", method = RequestMethod.POST)
     ...
     * @return
     */
    @RequestMapping(value = "/dealerSaleAfter/list", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/after/sell/flow",method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/ship/expressInfo", method = RequestMethod.GET)
